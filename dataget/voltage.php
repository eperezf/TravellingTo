...
if ($Voltage_Secondary_Range_From == "N" && $Voltage_Secondary_Range_To == "N"){
	if ($Voltage_Primary_Range_From == "H" && $Voltage_Primary_Range_To == "H"){ 
	 $Voltage_Response= "Voltage from <strong>" . $Name_From . "</strong>: <strong>" . $Voltage_Primary_From . "V.</strong><br>Voltage from <strong>" . $Name_To . "</strong>: <strong>" . $Voltage_Primary_To . "V.</strong><br><strong> You don't need a voltage transformer.</strong> Check for plug compatibility below.";
	 $Voltage_Frame = "success";
	}
	elseif ($Voltage_Primary_Range_From == "H" && $Voltage_Primary_Range_To == "L"){
		$Voltage_Response= "Voltage from <strong>" . $Name_From . "</strong>: <strong>" . $Voltage_Primary_From . "V.</strong><br>Voltage from <strong>" . $Name_To . "</strong>: <strong>" . $Voltage_Primary_To . "V.</strong><br><strong> You need a voltage transformer that increases the voltage output.</strong> Check for plug compatibility below.";
		$Voltage_Frame="danger";
	}
	elseif ($Voltage_Primary_Range_From == "L" && $Voltage_Primary_Range_To == "H"){ 
		$Voltage_Response= "Voltage from <strong>" . $Name_From . "</strong>: <strong>" . $Voltage_Primary_From . "V.</strong><br>Voltage from <strong>" . $Name_To . "</strong>: <strong>" . $Voltage_Primary_To . "V.</strong><br><strong> You need a voltage transformer that reduces the voltage output.</strong> Check for plug compatibility below.";
		$Voltage_Frame="danger";
	}
...
elseif ($Voltage_Secondary_Range_From == "N" && $Voltage_Secondary_Range_To != "N"){ 
	if ($Voltage_Primary_Range_From == "H" && $Voltage_Primary_Range_To == "H" && $Voltage_Secondary_Range_To == "H"){ 
		$Voltage_Response = "Voltage from <strong>" . $Name_From . "</strong>: <strong>" . $Voltage_Primary_From . "V.</strong><br> Voltages from <strong>" . $Name_To . "</strong>: <strong>" . $Voltage_Primary_To . "V and " . $Voltage_Secondary_To . "V.</strong><br><strong>You don't need a voltage transformer.</strong> Check for plug compatibility below.";
		$Voltage_Frame = "success";
	}
	elseif ($Voltage_Primary_Range_From == "H" && $Voltage_Primary_Range_To == "H" && $Voltage_Secondary_Range_To == "L"){ 
		$Voltage_Response = "Voltage from <strong>" . $Name_From . "</strong>: <strong>" . $Voltage_Primary_From . "V.</strong><br> Voltages from <strong>" . $Name_To . "</strong>: <strong>" . $Voltage_Primary_To . "V and " . $Voltage_Secondary_To . "V.</strong><br><strong>In some cases you will need a transformer that increases the voltage output</strong> Check for plug compatibility below.";
...
elseif ($Voltage_Secondary_Range_From != "N" && $Voltage_Secondary_Range_To == "N"){ 
	if ($Voltage_Primary_Range_From == "H" && $Voltage_Secondary_Range_From == "H" && $Voltage_Secondary_Range_To == "H"){ 
		$Voltage_Response = "HHHN. OK. Voltages from " . $Name_From . ": " . $Voltage_Primary_From . "V and " . $Voltage_Secondary_From . "V.<br> Voltage from " . $Name_To . ": " . $Voltage_Primary_To . "V.<br><strong>You don't need a voltage transformer.</strong> Check for plug compatibility below.";
		$Voltage_Frame = "success";
	}
	elseif ($Voltage_Primary_Range_From == "H" && $Voltage_Secondary_Range_From == "H" && $Voltage_Primary_Range_To == "L"){ 
		$Voltage_Response = "Voltages from <strong>" . $Name_From . "</strong>: <strong>" . $Voltage_Primary_From . "V and " . $Voltage_Secondary_From . "V.</strong><br> Voltage from <strong>" . $Name_To . "</strong>: <strong>" . $Voltage_Primary_To . "V.</strong><br><strong>You need a voltage transformer that increases the voltage output.</strong> Check for plug compatibility below.";
		$Voltage_Frame="danger";
	}
	...
	elseif ($Voltage_Primary_Range_From == "L" && $Voltage_Secondary_Range_From == "L" && $Voltage_Primary_Range_To == "L"){ 
		$Voltage_Response = "Voltages from <strong>" . $Name_From . "</strong>: <strong>" . $Voltage_Primary_From . "V and " . $Voltage_Secondary_From . "V.</strong><br> Voltage from <strong>" . $Name_To . "</strong>: <strong>" . $Voltage_Primary_To . "V.</strong><br><strong>You don't need a voltage transformer.</strong> Check for plug compatibility below.";
		$Voltage_Frame = "success";
	}
